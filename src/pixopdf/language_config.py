...
_ADVANCED_WORKFLOW_TRANSLATIONS: dict[str, dict[str, str]] = {
    "fr": {
        "layout_resize_action": "Modifier le format",
        "layout_resize_description": "Adaptez les pages sans rogner leur contenu.",
        "layout_nup_action": "Plusieurs pages par feuille",
        "layout_nup_description": "Regroupez les pages pour l’impression.",
        "target_format": "Format cible",
        "placement": "Placement",
        "fit": "Ajuster",
        "fill": "Remplir",
        "actual_size": "Taille réelle",
        "fit_without_upscale": "Ajuster sans agrandir",
        "pages_per_sheet": "Pages par feuille",
        "margin_mm": "Marge (mm)",
        "sheet": "Feuille",
        "layout_export_hint": (
            "Les indices d’origine restent fixes. Le PDF transformé est créé à l’export."
        ),
        "convert_choose_type": "Choisissez le type de conversion.",
        "pdf_to_images": "PDF vers images",
        "pdf_to_images_description": "Créez une image fidèle pour chaque page active.",
        "images_to_pdf": "Images vers PDF",
        "images_to_pdf_description": "Assemblez les images dans leur ordre de sélection.",
        "extract_images": "Extraire les images",
        "extract_images_description": "Récupérez les images incorporées dans le PDF.",
        "image_format": "Format",
        "resolution_dpi": "Résolution (DPI)",
        "jpeg_quality": "Qualité JPEG",
        "choose_images": "Choisir des images",
        "no_images_selected": "Aucune image sélectionnée",
        "images_ready": "{count} image(s) prête(s) · {names}",
        "adapt_to_each_image": "Adapter à chaque image",
        "original_format_if_possible": "Format original si possible",
        "output": "Sortie",
        "protect_memory_notice": (
            "Les mots de passe restent uniquement en mémoire pendant le traitement."
        ),
        "open_password_action": "Mot de passe d’ouverture",
        "open_password_description": "Exigez un mot de passe pour ouvrir le PDF.",
        "permissions_action": "Permissions",
        "permissions_description": "Définissez les usages autorisés du document.",
        "remove_password_action": "Retirer un mot de passe",
        "remove_password_description": "Créez une copie déverrouillée avec le mot de passe.",
        "password": "Mot de passe",
        "confirm_password": "Confirmer le mot de passe",
        "owner_password": "Mot de passe propriétaire",
        "confirm_owner_password": "Confirmer le mot de passe propriétaire",
        "current_password": "Mot de passe actuel",
        "allow_print": "Autoriser l’impression",
        "allow_copy": "Autoriser la copie du contenu",
        "allow_modify": "Autoriser les modifications",
        "choose_protected_pdf": "Choisir un PDF protégé",
        "use_active_document": "Utiliser le document actif",
        "permissions_advisory": (
            "Les permissions PDF peuvent être ignorées par certains lecteurs."
        ),
        "enter_password_feedback": "Saisissez puis confirmez le mot de passe.",
        "passwords_mismatch": "Les mots de passe ne correspondent pas.",
        "protection_ready": "Configuration valide · prête à exporter.",
        "remove_password_feedback": "Choisissez le PDF et saisissez son mot de passe actuel.",
        "signature_kind_notice": (
            "Une signature visuelle est graphique; seule la signature numérique est vérifiable."
        ),
        "visual_signature": "Signature visuelle",
        "visual_signature_description": "Ajoutez une image sur les pages sélectionnées.",
        "digital_signature": "Signature numérique",
        "digital_signature_description": "Signez le PDF final avec un certificat PKCS#12.",
        "add_date": "Ajouter la date",
        "add_date_description": "Ajoutez la date courante comme tampon visible.",
        "choose_signature": "Choisir une signature",
        "no_signature_selected": "Aucune image sélectionnée",
        "choose_certificate": "Choisir un certificat",
        "no_certificate_selected": "Aucun certificat sélectionné",
        "certificate_password": "Mot de passe du certificat",
        "signature_reason": "Motif de la signature (facultatif)",
        ...
        "compress_choose_profile": "Choisissez le compromis entre qualité et poids.",
        "compression_source_summary": "Taille source : {source} Mo · cible suggérée : {target} Mo",
        "compression_light": "Compression légère",
        "compression_light_description": "Optimisation sans perte; qualité inchangée.",
        "compression_balanced": "Compression équilibrée",
        "compression_balanced_description": "Réduction des images avec une qualité élevée.",
        "compression_maximum": "Compression maximale",
        "compression_maximum_description": "Réduction forte pour l’envoi et le web.",
        "compression_target": "Atteindre une taille cible",
        "compression_target_description": "PixoPDF choisit automatiquement le taux adapté.",
        "compression_advanced": "Mode avancé",
        "compression_advanced_description": (
            "Choisissez le DPI, une taille cible, ou combinez les deux."
        ),
        "compression_use_dpi": "Limiter le DPI",
        "compression_use_target": "Taille cible",
        "compression_live_estimate": (
            "Source : {source} Mo  →  sortie estimée : {output} Mo  ·  −{saving} %"
        ),
        "compression_estimate_unavailable": (
            "Ajoutez un PDF pour afficher l’estimation de sortie."
        ),
        "compression_choose_advanced_setting": "Activez le DPI et/ou la taille cible.",
        "compression_exact_result": (
            "Source : {source} Mo  →  sortie calculée : {output} Mo  ·  −{saving} %"
        ),
        "compression_preview_scheduled": "Calcul exact programmé…",
        "compression_preview_ready": "Taille exacte calculée · résultat prêt pour l’export.",
        "compression_preview_cached": "Taille exacte restaurée depuis le cache local.",
        "compression_preview_cancelled": "Calcul exact annulé · estimation indicative affichée.",
        "compression_preview_error": "Calcul exact indisponible : {message}",
        "compression_stage_preparing": "Préparation du PDF…",
        "compression_stage_optimizing": "Optimisation des pages {current}/{total}…",
        "compression_stage_testing": "Test du réglage {current}/{total}…",
        "compression_stage_rasterizing": "Rasterisation {current}/{total}…",
        "compression_stage_saving": "Enregistrement sécurisé…",
        "compression_stage_complete": "Compression terminée",
        "operation_cancelling": "Annulation en cours…",
        "operation_cancelled": "Opération annulée sans modifier la destination.",
        "megabyte_suffix": " Mo",
        "target_size": "Taille souhaitée",
        "allow_aggressive_compression": "Autoriser le mode raster",
        "compression_raster_option_warning": (
            "Le mode raster supprime le texte sélectionnable, les liens et les formulaires."
        ),
        "target_size_notice": (
            "L’estimation s’actualise avant l’export et reste indicative. PixoPDF préserve "
            "d’abord le texte et les vecteurs."
        ),
        "layout_create_sheets": "Créer les feuilles",
        "layout_adapt_export": "Adapter et exporter",
        "layout_export_tooltip": "Choisir le PDF mis en page à créer",
        "convert_to_images": "Convertir en images",
        "create_pdf": "Créer le PDF",
        "conversion_export_tooltip": "Choisir la destination puis lancer la conversion",
        "protect_and_export": "Protéger et exporter",
        "apply_permissions": "Appliquer les permissions",
        "create_unlocked_copy": "Créer une copie déverrouillée",
        "choose_pdf_destination": "Choisir le PDF de destination",
        "add_signature": "Ajouter la signature",
        "sign_digitally": "Signer numériquement",
        "sign_export_tooltip": "Choisir le PDF signé à créer",
        "target_size_button": "Viser {size} Mo",
        "compress_and_export": "Compresser et exporter",
        "compress_export_tooltip": "Choisir le PDF compressé à créer",
        "choose_conversion_images_dialog": "Choisir les images à convertir",
        "choose_signature_image_dialog": "Choisir une image de signature",
        "choose_certificate_dialog": "Choisir un certificat numérique",
        "choose_protected_pdf_dialog": "Choisir un PDF protégé",
        "layout_save_dialog": "Exporter le PDF mis en page",
        "layout_in_progress": "Mise en page du PDF en cours…",
        "layout_error_title": "Mise en page impossible",
        "images_pdf_save_dialog": "Créer le PDF à partir des images",
        "images_output_folder_dialog": "Choisir le dossier de destination des images",
        "conversion_in_progress": "Conversion en cours…",
        "conversion_error_title": "Conversion impossible",
        "protect_save_dialog": "Exporter le PDF protégé",
        "protection_in_progress": "Protection du PDF en cours…",
        "protection_error_title": "Protection impossible",
        "sign_save_dialog": "Exporter le PDF signé",
        "signed_on_prefix": "Signé le ",
        "signature_in_progress": "Signature du PDF en cours…",
        "signature_error_title": "Signature impossible",
        "compress_save_dialog": "Exporter le PDF compressé",
        "compression_in_progress": "Compression et optimisation en cours…",
        "compression_error_title": "Compression impossible",
        "target_reached": "taille cible atteinte",
        "target_not_reached": "cible non atteinte",
        "compression_done": "Compression terminée : {source} → {output} Mo{target}",
        "compression_raster_warning": (
            "Le mode raster a été utilisé : texte sélectionnable, liens, formulaires et "
            "calques interactifs ne sont plus conservés."
        ),
        "compression_target_warning": (
            "La taille demandée ne peut pas être atteinte sans dépasser les limites de qualité."
        ),
        "compression_no_gain_warning": "Le PDF source était déjà optimisé.",
        "compression_already_small_warning": (
            "Le fichier respectait déjà la cible et a été copié sans perte."
        ),
        "files_created": "Traitement terminé : {count} fichier(s) créé(s).",
        "file_created": "Fichier créé : {path}",
        "unexpected_operation_result": "Résultat de traitement inattendu",
    },
    "en": {
        "layout_resize_action": "Change page size",
        "layout_resize_description": "Fit pages without cropping their content.",
        "layout_nup_action": "Multiple pages per sheet",
        "layout_nup_description": "Group pages on sheets for printing.",
        "target_format": "Target size",
        "placement": "Placement",
        "fit": "Fit",
        "fill": "Fill",
        "actual_size": "Actual size",
        "fit_without_upscale": "Fit without enlarging",
        "pages_per_sheet": "Pages per sheet",
        "margin_mm": "Margin (mm)",
        "sheet": "Sheet",
        "layout_export_hint": (
            "Original indices stay fixed. The transformed PDF is created on export."
        ),
        "convert_choose_type": "Choose a conversion type.",
        "pdf_to_images": "PDF to images",
        "pdf_to_images_description": "Create a faithful image for each active page.",
        "images_to_pdf": "Images to PDF",
        "images_to_pdf_description": "Assemble images in the selected order.",
        "extract_images": "Extract images",
        "extract_images_description": "Recover images embedded in the PDF.",
        "image_format": "Format",
        "resolution_dpi": "Resolution (DPI)",
        "jpeg_quality": "JPEG quality",
        "choose_images": "Choose images",
        "no_images_selected": "No images selected",
        "images_ready": "{count} image(s) ready · {names}",
        "adapt_to_each_image": "Fit to each image",
        "original_format_if_possible": "Original format when possible",
        "output": "Output",
        "protect_memory_notice": "Passwords remain in memory only during processing.",
        "open_password_action": "Opening password",
        "open_password_description": "Require a password to open the PDF.",
        "permissions_action": "Permissions",
        "permissions_description": "Define the permitted uses of the document.",
        "remove_password_action": "Remove password",
        "remove_password_description": "Create an unlocked copy using the password.",
        "password": "Password",
        "confirm_password": "Confirm password",
        "owner_password": "Owner password",
        "confirm_owner_password": "Confirm owner password",
        "current_password": "Current password",
        "allow_print": "Allow printing",
        "allow_copy": "Allow content copying",
        "allow_modify": "Allow changes",
        "choose_protected_pdf": "Choose a protected PDF",
        "use_active_document": "Use active document",
        "permissions_advisory": "Some PDF readers may ignore document permissions.",
        "enter_password_feedback": "Enter and confirm the password.",
        "passwords_mismatch": "The passwords do not match.",
        "protection_ready": "Valid configuration · ready to export.",
        "remove_password_feedback": "Choose the PDF and enter its current password.",
        "signature_kind_notice": (
            "A visual signature is graphical; only a digital signature is verifiable."
        ),
        "visual_signature": "Visual signature",
        "visual_signature_description": "Add an image to the selected pages.",
        "digital_signature": "Digital signature",
        "digital_signature_description": "Sign the final PDF with a PKCS#12 certificate.",
        "add_date": "Add date",
        "add_date_description": "Add the current date as a visible stamp.",
        "choose_signature": "Choose signature",
        "no_signature_selected": "No image selected",
        "choose_certificate": "Choose certificate",
        "no_certificate_selected": "No certificate selected",
        "certificate_password": "Certificate password",
        "signature_reason": "Signing reason (optional)",
        ...
        "compress_choose_profile": "Choose the balance between quality and size.",
        "compression_source_summary": "Source size: {source} MB · suggested target: {target} MB",
        "compression_light": "Light compression",
        "compression_light_description": "Lossless optimization; unchanged quality.",
        "compression_balanced": "Balanced compression",
        "compression_balanced_description": "Reduce images while retaining high quality.",
        "compression_maximum": "Maximum compression",
        "compression_maximum_description": "Strong reduction for sharing and the web.",
        "compression_target": "Reach a target size",
        "compression_target_description": "PixoPDF automatically selects the best rate.",
        "compression_advanced": "Advanced mode",
        "compression_advanced_description": ("Choose a DPI, a target size, or combine both."),
        "compression_use_dpi": "Limit DPI",
        "compression_use_target": "Target size",
        "compression_live_estimate": (
            "Source: {source} MB  →  estimated output: {output} MB  ·  −{saving}%"
        ),
        "compression_estimate_unavailable": "Add a PDF to display the output estimate.",
        "compression_choose_advanced_setting": "Enable DPI and/or target size.",
        "compression_exact_result": (
            "Source: {source} MB  →  calculated output: {output} MB  ·  −{saving}%"
        ),
        "compression_preview_scheduled": "Exact calculation scheduled…",
        "compression_preview_ready": "Exact size calculated · result ready for export.",
        "compression_preview_cached": "Exact size restored from the local cache.",
        "compression_preview_cancelled": "Exact calculation cancelled · estimate displayed.",
        "compression_preview_error": "Exact calculation unavailable: {message}",
        "compression_stage_preparing": "Preparing PDF…",
        "compression_stage_optimizing": "Optimizing pages {current}/{total}…",
        "compression_stage_testing": "Testing setting {current}/{total}…",
        "compression_stage_rasterizing": "Rasterizing {current}/{total}…",
        "compression_stage_saving": "Saving securely…",
        "compression_stage_complete": "Compression complete",
        "operation_cancelling": "Cancelling…",
        "operation_cancelled": "Operation cancelled without changing the destination.",
        "megabyte_suffix": " MB",
        "target_size": "Desired size",
        "allow_aggressive_compression": "Allow raster mode",
        "compression_raster_option_warning": (
            "Raster mode removes selectable text, links, and forms."
        ),
        "target_size_notice": (
            "The estimate updates before export and remains indicative. PixoPDF preserves "
            "text and vectors first."
        ),
        "layout_create_sheets": "Create sheets",
        "layout_adapt_export": "Fit and export",
        "layout_export_tooltip": "Choose the laid-out PDF to create",
        "convert_to_images": "Convert to images",
        "create_pdf": "Create PDF",
        "conversion_export_tooltip": "Choose the destination and start conversion",
        "protect_and_export": "Protect and export",
        "apply_permissions": "Apply permissions",
        "create_unlocked_copy": "Create unlocked copy",
        "choose_pdf_destination": "Choose the destination PDF",
        "add_signature": "Add signature",
        "sign_digitally": "Sign digitally",
        "sign_export_tooltip": "Choose the signed PDF to create",
        "target_size_button": "Target {size} MB",
        "compress_and_export": "Compress and export",
        "compress_export_tooltip": "Choose the compressed PDF to create",
        "choose_conversion_images_dialog": "Choose images to convert",
        "choose_signature_image_dialog": "Choose a signature image",
        "choose_certificate_dialog": "Choose a digital certificate",
        "choose_protected_pdf_dialog": "Choose a protected PDF",
        "layout_save_dialog": "Export laid-out PDF",
        "layout_in_progress": "Laying out PDF…",
        "layout_error_title": "Layout failed",
        "images_pdf_save_dialog": "Create PDF from images",
        "images_output_folder_dialog": "Choose the image output folder",
        "conversion_in_progress": "Converting…",
        "conversion_error_title": "Conversion failed",
        "protect_save_dialog": "Export protected PDF",
        "protection_in_progress": "Protecting PDF…",
        "protection_error_title": "Protection failed",
        "sign_save_dialog": "Export signed PDF",
        "signed_on_prefix": "Signed on ",
        "signature_in_progress": "Signing PDF…",
        "signature_error_title": "Signature failed",
        "compress_save_dialog": "Export compressed PDF",
        "compression_in_progress": "Compressing and optimizing…",
        "compression_error_title": "Compression failed",
        "target_reached": "target reached",
        "target_not_reached": "target not reached",
        "compression_done": "Compression complete: {source} → {output} MB{target}",
        "compression_raster_warning": (
            "Raster mode was used: selectable text, links, forms, and interactive layers "
            "are no longer preserved."
        ),
        "compression_target_warning": (
            "The requested size cannot be reached without exceeding the quality limits."
        ),
        "compression_no_gain_warning": "The source PDF was already optimized.",
        "compression_already_small_warning": (
            "The file already met the target and was copied without quality loss."
        ),
        "files_created": "Processing complete: {count} file(s) created.",
        "file_created": "File created: {path}",
        "unexpected_operation_result": "Unexpected processing result",
    },
    "zh": {
        "layout_resize_action": "修改页面尺寸",
        "layout_resize_description": "调整页面且不裁切内容。",
        "layout_nup_action": "每张纸多页",
        "layout_nup_description": "将多个页面组合到打印纸张上。",
        "target_format": "目标尺寸",
        "placement": "放置方式",
        "fit": "适应",
        "fill": "填充",
        "actual_size": "实际大小",
        "fit_without_upscale": "适应但不放大",
        "pages_per_sheet": "每张纸页数",
        "margin_mm": "边距（毫米）",
        "sheet": "纸张",
        "layout_export_hint": "原始编号保持不变，导出时创建转换后的 PDF。",
        "convert_choose_type": "选择转换类型。",
        "pdf_to_images": "PDF 转图片",
        "pdf_to_images_description": "为每个有效页面创建清晰图片。",
        "images_to_pdf": "图片转 PDF",
        "images_to_pdf_description": "按选择顺序将图片合并为 PDF。",
        "extract_images": "提取图片",
        "extract_images_description": "提取 PDF 中嵌入的图片。",
        "image_format": "格式",
        "resolution_dpi": "分辨率（DPI）",
        "jpeg_quality": "JPEG 质量",
        "choose_images": "选择图片",
        "no_images_selected": "未选择图片",
        "images_ready": "已准备 {count} 张图片 · {names}",
        "adapt_to_each_image": "适应每张图片",
        "original_format_if_possible": "尽量保留原格式",
        "output": "输出",
        "protect_memory_notice": "密码仅在处理期间保留于内存。",
        "open_password_action": "打开密码",
        "open_password_description": "打开 PDF 时要求输入密码。",
        "permissions_action": "权限",
        "permissions_description": "设置文档允许的操作。",
        "remove_password_action": "移除密码",
        "remove_password_description": "使用密码创建未锁定副本。",
        "password": "密码",
        "confirm_password": "确认密码",
        "owner_password": "所有者密码",
        "confirm_owner_password": "确认所有者密码",
        "current_password": "当前密码",
        "allow_print": "允许打印",
        "allow_copy": "允许复制内容",
        "allow_modify": "允许修改",
        "choose_protected_pdf": "选择受保护的 PDF",
        "use_active_document": "使用当前文档",
        "permissions_advisory": "部分 PDF 阅读器可能忽略文档权限。",
        "enter_password_feedback": "输入并确认密码。",
        "passwords_mismatch": "两次输入的密码不一致。",
        "protection_ready": "配置有效 · 可以导出。",
        "remove_password_feedback": "选择 PDF 并输入当前密码。",
        "signature_kind_notice": "可视签名仅是图形；只有数字签名可验证。",
        "visual_signature": "可视签名",
        "visual_signature_description": "在所选页面添加签名图片。",
        "digital_signature": "数字签名",
        "digital_signature_description": "使用 PKCS#12 证书签署最终 PDF。",
        "add_date": "添加日期",
        "add_date_description": "将当前日期添加为可见印章。",
        "choose_signature": "选择签名",
        "no_signature_selected": "未选择图片",
        "choose_certificate": "选择证书",
        "no_certificate_selected": "未选择证书",
        "certificate_password": "证书密码",
        "signature_reason": "签名原因（可选）",
        "bottom_right": "右下",
        "bottom_left": "左下",
        "top_right": "右上",
        "top_left": "左上",
        "center": "居中",
        "include_time": "包含时间",
        "compress_choose_profile": "选择质量与文件大小之间的平衡。",
        "compression_source_summary": "源文件：{source} MB · 建议目标：{target} MB",
        "compression_light": "轻度压缩",
        "compression_light_description": "无损优化；质量不变。",
        "compression_balanced": "均衡压缩",
        "compression_balanced_description": "在保持高质量的同时缩小图片。",
        "compression_maximum": "最大压缩",
        "compression_maximum_description": "适合分享和网页的强力压缩。",
        "compression_target": "达到目标大小",
        "compression_target_description": "PixoPDF 自动选择合适的压缩率。",
        "compression_advanced": "高级模式",
        "compression_advanced_description": "选择 DPI、目标大小，或同时使用两者。",
        "compression_use_dpi": "限制 DPI",
        "compression_use_target": "目标大小",
        "compression_live_estimate": (
            "源文件：{source} MB  →  预计输出：{output} MB  ·  减少 {saving}%"
        ),
        "compression_estimate_unavailable": "添加 PDF 后即可显示输出大小估计。",
        "compression_choose_advanced_setting": "请启用 DPI 和/或目标大小。",
        "compression_exact_result": (
            "源文件：{source} MB  →  计算输出：{output} MB  ·  减少 {saving}%"
        ),
        "compression_preview_scheduled": "已安排精确计算…",
        "compression_preview_ready": "已计算精确大小，可直接导出。",
        "compression_preview_cached": "已从本地缓存恢复精确大小。",
        "compression_preview_cancelled": "精确计算已取消，当前显示估计值。",
        "compression_preview_error": "无法进行精确计算：{message}",
        "compression_stage_preparing": "正在准备 PDF…",
        "compression_stage_optimizing": "正在优化页面 {current}/{total}…",
        "compression_stage_testing": "正在测试设置 {current}/{total}…",
        "compression_stage_rasterizing": "正在栅格化 {current}/{total}…",
        "compression_stage_saving": "正在安全保存…",
        "compression_stage_complete": "压缩完成",
        "operation_cancelling": "正在取消…",
        "operation_cancelled": "操作已取消，目标文件未被修改。",
        "megabyte_suffix": " MB",
        "target_size": "目标大小",
        "allow_aggressive_compression": "允许栅格模式",
        "compression_raster_option_warning": "栅格模式会移除可选文本、链接和表单。",
        "target_size_notice": "估计会在导出前即时更新，仅供参考。PixoPDF 会优先保留文本和矢量。",
        "layout_create_sheets": "创建纸张",
        "layout_adapt_export": "调整并导出",
        "layout_export_tooltip": "选择要创建的排版 PDF",
        "convert_to_images": "转换为图片",
        "create_pdf": "创建 PDF",
        "conversion_export_tooltip": "选择目标位置并开始转换",
        "protect_and_export": "保护并导出",
        "apply_permissions": "应用权限",
        "create_unlocked_copy": "创建未锁定副本",
        "choose_pdf_destination": "选择目标 PDF",
        "add_signature": "添加签名",
        "sign_digitally": "数字签名",
        "sign_export_tooltip": "选择要创建的已签名 PDF",
        "target_size_button": "目标 {size} MB",
        "compress_and_export": "压缩并导出",
        "compress_export_tooltip": "选择要创建的压缩 PDF",
        "choose_conversion_images_dialog": "选择要转换的图片",
        "choose_signature_image_dialog": "选择签名图片",
        "choose_certificate_dialog": "选择数字证书",
        "choose_protected_pdf_dialog": "选择受保护的 PDF",
        "layout_save_dialog": "导出排版后的 PDF",
        "layout_in_progress": "正在排版 PDF…",
        "layout_error_title": "排版失败",
        "images_pdf_save_dialog": "从图片创建 PDF",
        "images_output_folder_dialog": "选择图片输出文件夹",
        "conversion_in_progress": "正在转换…",
        "conversion_error_title": "转换失败",
        "protect_save_dialog": "导出受保护的 PDF",
        "protection_in_progress": "正在保护 PDF…",
        "protection_error_title": "保护失败",
        "sign_save_dialog": "导出已签名 PDF",
        "signed_on_prefix": "签署于 ",
        "signature_in_progress": "正在签署 PDF…",
        "signature_error_title": "签名失败",
        "compress_save_dialog": "导出压缩后的 PDF",
        "compression_in_progress": "正在压缩和优化…",
        "compression_error_title": "压缩失败",
        "target_reached": "已达到目标大小",
        "target_not_reached": "未达到目标大小",
        "compression_done": "压缩完成：{source} → {output} MB{target}",
        "compression_raster_warning": (
            "已使用栅格模式：可选文本、链接、表单和交互图层将不再保留。"
        ),
        "compression_target_warning": "在不超出质量下限的情况下无法达到指定大小。",
        "compression_no_gain_warning": "源 PDF 已经优化。",
        "compression_already_small_warning": "文件已满足目标大小，已无损复制。",
        "files_created": "处理完成：已创建 {count} 个文件。",
        "file_created": "已创建文件：{path}",
        "unexpected_operation_result": "处理结果异常",
    },
    "ar": {
        "layout_resize_action": "تغيير حجم الصفحة",
        "layout_resize_description": "ملاءمة الصفحات من دون قص المحتوى.",
        "layout_nup_action": "عدة صفحات في الورقة",
        "layout_nup_description": "تجميع الصفحات في أوراق للطباعة.",
        "target_format": "الحجم الهدف",
        "placement": "الموضع",
        "fit": "ملاءمة",
        "fill": "ملء",
        "actual_size": "الحجم الفعلي",
        "fit_without_upscale": "ملاءمة من دون تكبير",
        "pages_per_sheet": "صفحات لكل ورقة",
        "margin_mm": "الهامش (مم)",
        "sheet": "الورقة",
        "layout_export_hint": "تبقى الفهارس الأصلية ثابتة ويُنشأ PDF عند التصدير.",
        "convert_choose_type": "اختر نوع التحويل.",
        "pdf_to_images": "PDF إلى صور",
        "pdf_to_images_description": "إنشاء صورة واضحة لكل صفحة نشطة.",
        "images_to_pdf": "صور إلى PDF",
        "images_to_pdf_description": "تجميع الصور وفق ترتيب الاختيار.",
        "extract_images": "استخراج الصور",
        "extract_images_description": "استخراج الصور المضمّنة في PDF.",
        "image_format": "التنسيق",
        "resolution_dpi": "الدقة (DPI)",
        "jpeg_quality": "جودة JPEG",
        "choose_images": "اختيار الصور",
        "no_images_selected": "لم تُحدد صور",
        "images_ready": "{count} صورة جاهزة · {names}",
        "adapt_to_each_image": "ملاءمة كل صورة",
        "original_format_if_possible": "التنسيق الأصلي إن أمكن",
        "output": "الإخراج",
        "protect_memory_notice": "تبقى كلمات المرور في الذاكرة أثناء المعالجة فقط.",
        "open_password_action": "كلمة مرور الفتح",
        "open_password_description": "طلب كلمة مرور لفتح PDF.",
        "permissions_action": "الأذونات",
        "permissions_description": "تحديد الاستخدامات المسموح بها للمستند.",
        "remove_password_action": "إزالة كلمة المرور",
        "remove_password_description": "إنشاء نسخة غير مقفلة باستخدام كلمة المرور.",
        "password": "كلمة المرور",
        "confirm_password": "تأكيد كلمة المرور",
        "owner_password": "كلمة مرور المالك",
        "confirm_owner_password": "تأكيد كلمة مرور المالك",
        "current_password": "كلمة المرور الحالية",
        "allow_print": "السماح بالطباعة",
        "allow_copy": "السماح بنسخ المحتوى",
        "allow_modify": "السماح بالتعديلات",
        "choose_protected_pdf": "اختيار PDF محمي",
        "use_active_document": "استخدام المستند النشط",
        "permissions_advisory": "قد تتجاهل بعض قارئات PDF أذونات المستند.",
        "enter_password_feedback": "أدخل كلمة المرور ثم أكدها.",
        "passwords_mismatch": "كلمتا المرور غير متطابقتين.",
        "protection_ready": "الإعداد صالح · جاهز للتصدير.",
        "remove_password_feedback": "اختر PDF وأدخل كلمة مروره الحالية.",
        "signature_kind_notice": "التوقيع المرئي رسومي؛ التوقيع الرقمي وحده قابل للتحقق.",
        "visual_signature": "توقيع مرئي",
        "visual_signature_description": "إضافة صورة إلى الصفحات المحددة.",
        "digital_signature": "توقيع رقمي",
        "digital_signature_description": "توقيع PDF النهائي بشهادة PKCS#12.",
        "add_date": "إضافة التاريخ",
        "add_date_description": "إضافة التاريخ الحالي كختم مرئي.",
        "choose_signature": "اختيار توقيع",
        "no_signature_selected": "لم تُحدد صورة",
        "choose_certificate": "اختيار شهادة",
        "no_certificate_selected": "لم تُحدد شهادة",
        "certificate_password": "كلمة مرور الشهادة",
        "signature_reason": "سبب التوقيع (اختياري)",
        ...
        "compress_choose_profile": "اختر التوازن بين الجودة والحجم.",
        "compression_source_summary": "حجم المصدر: {source} م.ب · الهدف المقترح: {target} م.ب",
        "compression_light": "ضغط خفيف",
        "compression_light_description": "تحسين بلا فقد؛ جودة ثابتة.",
        "compression_balanced": "ضغط متوازن",
        "compression_balanced_description": "تقليل الصور مع الحفاظ على جودة عالية.",
        "compression_maximum": "ضغط أقصى",
        "compression_maximum_description": "تقليل قوي للمشاركة والويب.",
        "compression_target": "بلوغ حجم مستهدف",
        "compression_target_description": "يختار PixoPDF معدل الضغط تلقائياً.",
        "compression_advanced": "الوضع المتقدم",
        "compression_advanced_description": ("اختر دقة DPI أو حجماً مستهدفاً أو اجمع بينهما."),
        "compression_use_dpi": "تحديد DPI",
        "compression_use_target": "الحجم المستهدف",
        "compression_live_estimate": (
            "المصدر: {source} م.ب  ←  الإخراج المقدّر: {output} م.ب  ·  أقل بنسبة {saving}%"
        ),
        "compression_estimate_unavailable": "أضف ملف PDF لعرض تقدير حجم الإخراج.",
        "compression_choose_advanced_setting": "فعّل الدقة و/أو الحجم المستهدف.",
        "compression_exact_result": (
            "المصدر: {source} م.ب  ←  الإخراج المحسوب: {output} م.ب  ·  أقل بنسبة {saving}%"
        ),
        "compression_preview_scheduled": "تمت جدولة الحساب الدقيق…",
        "compression_preview_ready": "حُسب الحجم الدقيق والنتيجة جاهزة للتصدير.",
        "compression_preview_cached": "استُعيد الحجم الدقيق من الذاكرة المحلية.",
        "compression_preview_cancelled": "أُلغي الحساب الدقيق ويُعرض التقدير التقريبي.",
        "compression_preview_error": "الحساب الدقيق غير متاح: {message}",
        "compression_stage_preparing": "جارٍ إعداد PDF…",
        "compression_stage_optimizing": "جارٍ تحسين الصفحات {current}/{total}…",
        "compression_stage_testing": "جارٍ اختبار الإعداد {current}/{total}…",
        "compression_stage_rasterizing": "جارٍ التحويل إلى صور {current}/{total}…",
        "compression_stage_saving": "جارٍ الحفظ الآمن…",
        "compression_stage_complete": "اكتمل الضغط",
        "operation_cancelling": "جارٍ الإلغاء…",
        "operation_cancelled": "أُلغيت العملية من دون تعديل ملف الوجهة.",
        "megabyte_suffix": " م.ب",
        "target_size": "الحجم المطلوب",
        "allow_aggressive_compression": "السماح بالوضع النقطي",
        "compression_raster_option_warning": (
            "يزيل الوضع النقطي النص القابل للتحديد والروابط والنماذج."
        ),
        "target_size_notice": (
            "يتحدث التقدير قبل التصدير ويبقى تقريبياً. يحافظ PixoPDF أولاً على النص والمتجهات."
        ),
        "layout_create_sheets": "إنشاء الأوراق",
        "layout_adapt_export": "ملاءمة وتصدير",
        "layout_export_tooltip": "اختيار ملف PDF المنسق المراد إنشاؤه",
        "convert_to_images": "تحويل إلى صور",
        "create_pdf": "إنشاء PDF",
        "conversion_export_tooltip": "اختيار الوجهة وبدء التحويل",
        "protect_and_export": "حماية وتصدير",
        "apply_permissions": "تطبيق الأذونات",
        "create_unlocked_copy": "إنشاء نسخة غير مقفلة",
        "choose_pdf_destination": "اختيار PDF الوجهة",
        "add_signature": "إضافة التوقيع",
        "sign_digitally": "توقيع رقمي",
        "sign_export_tooltip": "اختيار PDF الموقّع المراد إنشاؤه",
        "target_size_button": "استهداف {size} م.ب",
        "compress_and_export": "ضغط وتصدير",
        "compress_export_tooltip": "اختيار PDF المضغوط المراد إنشاؤه",
        "choose_conversion_images_dialog": "اختيار الصور المراد تحويلها",
        "choose_signature_image_dialog": "اختيار صورة توقيع",
        "choose_certificate_dialog": "اختيار شهادة رقمية",
        "choose_protected_pdf_dialog": "اختيار PDF محمي",
        "layout_save_dialog": "تصدير PDF المنسق",
        "layout_in_progress": "جارٍ تنسيق PDF…",
        "layout_error_title": "تعذر التنسيق",
        "images_pdf_save_dialog": "إنشاء PDF من الصور",
        "images_output_folder_dialog": "اختيار مجلد إخراج الصور",
        "conversion_in_progress": "جارٍ التحويل…",
        "conversion_error_title": "تعذر التحويل",
        "protect_save_dialog": "تصدير PDF المحمي",
        "protection_in_progress": "جارٍ حماية PDF…",
        "protection_error_title": "تعذرت الحماية",
        "sign_save_dialog": "تصدير PDF الموقّع",
        "signed_on_prefix": "موقّع في ",
        "signature_in_progress": "جارٍ توقيع PDF…",
        "signature_error_title": "تعذر التوقيع",
        "compress_save_dialog": "تصدير PDF المضغوط",
        "compression_in_progress": "جارٍ الضغط والتحسين…",
        "compression_error_title": "تعذر الضغط",
        "target_reached": "تم بلوغ الحجم المستهدف",
        "target_not_reached": "لم يتم بلوغ الحجم المستهدف",
        "compression_done": "اكتمل الضغط: {source} ← {output} م.ب{target}",
        "compression_raster_warning": (
            "استُخدم الوضع النقطي؛ لم يعد النص القابل للتحديد والروابط والنماذج والطبقات "
            "التفاعلية محفوظة."
        ),
        "compression_target_warning": ("يتعذر بلوغ الحجم المطلوب من دون تجاوز حدود الجودة الدنيا."),
        "compression_no_gain_warning": "ملف PDF المصدر محسّن مسبقاً.",
        "compression_already_small_warning": (
            "كان الملف يطابق الحجم المستهدف، لذا نُسخ من دون فقدان الجودة."
        ),
        "files_created": "اكتملت المعالجة: تم إنشاء {count} ملف.",
        "file_created": "تم إنشاء الملف: {path}",
        "unexpected_operation_result": "نتيجة معالجة غير متوقعة",
    },
}

for _language, _catalogue in _ADVANCED_WORKFLOW_TRANSLATIONS.items():
    {"fr": _FR, "en": _EN, "zh": _ZH, "ar": _AR}[_language].update(_catalogue)

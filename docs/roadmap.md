...
- **1 / 0.1.0 — Organizer:** imports, thumbnails, selection, reorder, rotate, delete, duplicate, extraction, merge, blank pages, undo. Risk: large files; test encrypted/corrupt PDFs.
- **2 / 0.2.0 — Split & layout:** ranges, groups, A4/A5, 2/4-up, margins. Risk: geometry and print boxes.
